        ...
        <div className="flex items-center justify-center min-h-screen p-4">
          <div className="failure-card-blur w-full max-w-md rounded-3xl p-8 text-center">
            ...
            <p className="text-gray-600 text-sm mb-8 leading-relaxed">
              Google hesabınız ile giriş yapma işlemi tamamlanamadı. Bu durum geçici bir bağlantı 
              sorunu veya hesap ayarlarınızdan kaynaklı olabilir.
            </p>
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="failure-button-blur w-full flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300"
                tabIndex={0}
