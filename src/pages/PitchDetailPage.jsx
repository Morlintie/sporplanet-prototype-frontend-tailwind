...
function PitchDetailPage() {
  ...
  const transformDummyDataToPitch = (item) => {
    ...
    return {
      ...
      location,
      fullAddress: address ? `${address.street}, ${address.neighborhood}, ${address.district}, ${address.city}` : "Adres bilgisi yok",
  ...
  if (!pitch) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Saha Bulunamadı</h2>
