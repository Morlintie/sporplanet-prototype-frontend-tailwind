function ProfileSidebar({ activeSection, onSectionChange }) {
  const menuItems = [
    ...
    { id: "tournaments", label: "Turnuvalarım", icon: "trophy" },
    { id: "messages", label: "Mesajlar", icon: "message" },
    { id: "comments", label: "Yorumlarım", icon: "comment" },
    { id: "invitations", label: "Davetlerim", icon: "mail" },
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-900 mb-6">Profil Menüsü</h2>
