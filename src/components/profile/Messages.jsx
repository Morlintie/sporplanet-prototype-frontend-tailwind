  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-8">
      ...
      <div className="space-y-4">
        {activeTab === "group" ? (
          groupChats.map((chat) => (
            <div key={chat.id} className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  <span className="font-medium">{chat.lastSender}:</span> {chat.lastMessage}
                </p>
              </div>
      ...
      {(activeTab === "group" && groupChats.length === 0) || (activeTab === "individual" && individualChats.length === 0) ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            {activeTab === "group" ? "Henüz grup sohbetiniz bulunmuyor." : "Henüz bireysel sohbetiniz bulunmuyor."}
          </p>
        </div>
      ) : null}
    </div>
