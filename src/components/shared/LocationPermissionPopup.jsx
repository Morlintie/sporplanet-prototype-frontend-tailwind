    ...
    <div className="maintenance-popup-overlay" onClick={onDecline}>
      ...
      >
        ...
        <div className="mb-5">
          <div
            className={`flex items-center justify-center w-16 h-16 ${
              icon === "delete" ? "bg-red-100" : "bg-green-100"
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={onAccept}
            className={`flex-1 px-4 py-3 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors font-semibold text-sm ${
              icon === "delete"
                ? "bg-red-600 hover:bg-red-700 focus:ring-red-500"
                : "bg-[rgb(0,128,0)] hover:bg-[rgb(0,100,0)] focus:ring-green-500"
            }`}
            tabIndex="0"
          >
            {acceptText}
